...
x<- logpop # create a vector x of the log10 of the 1952 population sizes
...
#a sample.
#qnorm and pnorm -http://msenux.redwoods.edu/math/R/StandardNormal.php
...
ps <- ((1:n) - 0.5)/n # finding quantiles for the normal distribution?need to read, http://math.arizona.edu/~ghystad/chapter3.pdf
#https://www.stat.auckland.ac.nz/~ihaka/787/lectures-quantiles-handouts.pdf
#http://influentialpoints.com/Training/quantiles_as_summary_statistics-principles-properties-assumptions.htm
